...
```
  ...
  python retrain.py\
  --output_graph=trained_model_inception/retrained_graph.pb \
  --output_labels=trained_model_inception/retrained_labels.txt \
  --image_dir=dataset
...
python tensorflow/examples/image_retraining/retrain.py \
    ...
    python retrain.py \ 
--output_graph=trained_model_mobilenetv1-usecase1/retrained_graph.pb \
--output_labels=trained_model_mobilenetv1-usecase1/retrained_labels.txt   \
--architecture mobilenet_1.0_224 \
--image_dir=train/train_mblnet
